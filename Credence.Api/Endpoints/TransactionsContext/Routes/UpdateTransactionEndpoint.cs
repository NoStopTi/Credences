...
public class UpdateTransactionEndpoint : IEndpoint
{
 ...
 app.MapPut(TransactionConst.UpdateTransaction, HandlerAsync)
        .WithName(TransactionConst.UpdateTransaction)
        .WithDescription(TransactionConst.UpdateTransactionDesc)
        .WithOrder(TransactionConst.UpdateTransactionOrder)
